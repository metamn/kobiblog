...
<div id="footer">
  <div class="wrapper clear">
    ...
    <div id="copyright">
      <?php  
             /*Hey there code reader! Hope you are enjoying Titan so far. I wanted to let you know the footer attribution link plays a vital role in exposing our open source themes to the WordPress community. I would really appreciate it if you could leave this message and the links below intact. Go ahead and add a 'Modified by' or similar next to the link if you have made changes. Questions? Send an email to info {at} thethemefoundry.com.*/ 
      ?>
